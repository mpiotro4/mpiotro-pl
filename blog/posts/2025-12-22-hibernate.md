...
* Zarządza cyklem życia obiektów (persisted, detached, transient)
...
Istnieją dwie implementacje API do rozmowy z bazą - **EntityManger** (JPA) i **Session** (Hibernate). Oba to obiekty, przez które wykonuje się operacje na bazie danych. Pełnią role mostu pomiędzy kodem Java a tabelami w bazie.
...
Gdy potrzebujesz bardziej złożonych operacji niż proste find() czy persist(), używasz języków zapytań. Masz do wyboru trzy podejścia:
