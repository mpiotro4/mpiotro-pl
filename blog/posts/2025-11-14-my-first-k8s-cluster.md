...
Notice the Pod names — they all contain the string `8886d869b`. That's the **ReplicaSet hash**, which Deployment automatically created under the hood. We can verify this:
